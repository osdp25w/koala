  ...
  steps: [
    {
      ...
      commands: [
        ...
        "echo '🧪 Running a single test first...'",
        "timeout 120 python manage.py test account.tests.test_auth.AuthViewTest.test_login_invalid_credentials --verbosity=3 || echo '❌ Single test failed or timed out'",
