...
class BikeErrorLogConstants:
    ...
    BATTERY_TEMP_WARNING = {
        ...
        'title': '電池溫度過高',
        'level': BikeErrorLog.LEVEL_WARNING,
    ...
    BATTERY_TEMP_CRITICAL = {
        ...
        'title': '電池溫度危險',
        'level': BikeErrorLog.LEVEL_CRITICAL,
    ...
    BATTERY_LEVEL_WARNING = {
        ...
        'title': '電池電量不足',
        'level': BikeErrorLog.LEVEL_WARNING,
        'message_format': '車輛 {bike_id} 電池電量偏低 ({battery_level}%)，建議儘快充電',
        'message_format_required_fields': ['battery_level'],
    ...
    BATTERY_LEVEL_CRITICAL = {
        ...
        'title': '電池電量極低',
        'level': BikeErrorLog.LEVEL_CRITICAL,
        'message_format': '車輛 {bike_id} 電池電量極低 ({battery_level}%)，即將無法使用',
        'message_format_required_fields': ['battery_level'],
